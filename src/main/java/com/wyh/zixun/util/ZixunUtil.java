...
import com.wyh.zixun.controller.LoginController;
...
public class ZixunUtil {
    ...
    public static String QINIU_DOMAIN_PREFIX = "http://xxx";
    public static String IMAGE_DIR = "D:/upload/";
    public static String[] IMAGE_FILE_EXT = new String[]{"png","jpg","jpeg","bmp","ico","gif"};
