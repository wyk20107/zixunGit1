        ...
        _tpl: [
            '<div>',
              '<div class="form-group">',
                '<div class="form-group">',
                    '<label class="col-sm-2 control-label">上传你喜欢的图片</label>',
                    ...
                    '</div>',
                '</div>',
                  '<div class="form-group"><label class="col-sm-2 control-label">起个好听的标题</label><div class="col-sm-10"><input class="js-title form-control" type="text"></div></div>',
                  '<div class="form-group"><label class="col-sm-2 control-label">该资讯的链接</label><div class="col-sm-10"><input class="js-link form-control" type="text"></div></div>',
                  '<div class="form-group">',
            ...
            handler: function () {
                ...
                new Upload({
                    ...
                    check: function (oFile, sType, nFileSize) {
                        var sMsg = nFileSize === 0 ? '文件大小不能为0' : /image/gi.test(sType || '') ? '' : '非图片文件!!!';
                        sMsg && alert(sMsg);
                        return !sMsg;
                    },
