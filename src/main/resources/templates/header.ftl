...
<header class="navbar navbar-default navbar-static-top bs-docs-nav" id="top" role="banner">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="http://127.0.0.1:8080/" class="navbar-brand logo">
                <h1>主页</h1>
            </a>
        </div>
        ...
        <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
            ...
            <ul class="nav navbar-nav navbar-right">
                    <#if user?exists>
                        ...
                        <li><a href="http://127.0.0.1:8080/msg/list">站内信</a></li>

                        <li class=""><a href="http://127.0.0.1:8080/user/${(user.id)!}">${(user.name)!}</a></li>

                        <li class=""><a href="http://127.0.0.1:8080/logout/">注销</a></li>
                    <#else>
